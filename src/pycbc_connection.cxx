...
// Generated-On: 2026-04-25 14:10:15
// Content-Hash: 4d37709b3ab44179e1472cd4022324ef
// ====================================================================================================
// ==========================================================================================
...
static PyObject*
pycbc_connection__append__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "append")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::append_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__append_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "append_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::append_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__decrement__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "decrement")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::decrement_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__decrement_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "decrement_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::decrement_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__exists__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "exists")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::exists_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__get__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "get")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::get_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__get_all_replicas__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "get_all_replicas")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::get_all_replicas_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__get_and_lock__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "get_and_lock")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::get_and_lock_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__get_and_touch__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "get_and_touch")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::get_and_touch_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__get_any_replica__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "get_any_replica")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::get_any_replica_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__get_projected__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "get_projected")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::get_projected_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__increment__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "increment")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::increment_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__increment_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "increment_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::increment_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__insert__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "insert")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::insert_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__insert_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "insert_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::insert_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__lookup_in__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "lookup_in")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::lookup_in_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__lookup_in_all_replicas__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "lookup_in_all_replicas")) {
    return nullptr;
  }
...
static PyObject*
pycbc_connection__lookup_in_any_replica__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "lookup_in_any_replica")) {
    return nullptr;
  }
...
static PyObject*
pycbc_connection__mutate_in__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "mutate_in")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::mutate_in_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__mutate_in_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "mutate_in_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::mutate_in_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__prepend__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "prepend")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::prepend_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__prepend_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "prepend_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::prepend_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__remove__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "remove")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::remove_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__remove_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "remove_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::remove_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__replace__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "replace")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::replace_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__replace_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "replace_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::replace_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__touch__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "touch")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::touch_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__unlock__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "unlock")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::unlock_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__upsert__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "upsert")) {
    return nullptr;
  }
  return self->conn->execute_kv_op<couchbase::core::operations::upsert_request>(
    reinterpret_cast<pycbc_kv_request*>(arg));
}

static PyObject*
pycbc_connection__upsert_with_legacy_durability__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_request(self, arg, "upsert_with_legacy_durability")) {
    return nullptr;
  }
  return self->conn
    ->execute_kv_op<couchbase::core::operations::upsert_request_with_legacy_durability>(
      reinterpret_cast<pycbc_kv_request*>(arg));
}
...
static PyObject*
pycbc_connection__append_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "append_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::append_request>(arg);
}

static PyObject*
pycbc_connection__append_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "append_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::append_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__decrement_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "decrement_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::decrement_request>(arg);
}

static PyObject*
pycbc_connection__decrement_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "decrement_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::decrement_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__exists_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "exists_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::exists_request>(arg);
}

static PyObject*
pycbc_connection__get_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "get_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::get_request>(arg);
}

static PyObject*
pycbc_connection__get_all_replicas_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "get_all_replicas_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::get_all_replicas_request>(arg);
}

static PyObject*
pycbc_connection__get_and_lock_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "get_and_lock_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::get_and_lock_request>(arg);
}

static PyObject*
pycbc_connection__get_and_touch_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "get_and_touch_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::get_and_touch_request>(arg);
}

static PyObject*
pycbc_connection__get_any_replica_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "get_any_replica_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::get_any_replica_request>(arg);
}

static PyObject*
pycbc_connection__increment_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "increment_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::increment_request>(arg);
}

static PyObject*
pycbc_connection__increment_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "increment_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::increment_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__insert_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "insert_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::insert_request>(arg);
}

static PyObject*
pycbc_connection__insert_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "insert_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::insert_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__prepend_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "prepend_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::prepend_request>(arg);
}

static PyObject*
pycbc_connection__prepend_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "prepend_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::prepend_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__remove_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "remove_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::remove_request>(arg);
}

static PyObject*
pycbc_connection__remove_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "remove_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::remove_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__replace_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "replace_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::replace_request>(arg);
}

static PyObject*
pycbc_connection__replace_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "replace_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::replace_request_with_legacy_durability>(arg);
}

static PyObject*
pycbc_connection__touch_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "touch_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::touch_request>(arg);
}

static PyObject*
pycbc_connection__unlock_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "unlock_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::unlock_request>(arg);
}

static PyObject*
pycbc_connection__upsert_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "upsert_multi")) {
    return nullptr;
  }
  return self->conn->execute_multi_op<couchbase::core::operations::upsert_request>(arg);
}

static PyObject*
pycbc_connection__upsert_with_legacy_durability_multi__(pycbc_connection* self, PyObject* arg)
{
  if (!validate_connection_and_multi_request(self, arg, "upsert_with_legacy_durability_multi")) {
    return nullptr;
  }
  return self->conn
    ->execute_multi_op<couchbase::core::operations::upsert_request_with_legacy_durability>(arg);
}
...
static PyMethodDef pycbc_connection_methods[] = {
  ...
  { "pycbc_get", (PyCFunction)pycbc_connection__get__, METH_O, PyDoc_STR("KV get operation") },
