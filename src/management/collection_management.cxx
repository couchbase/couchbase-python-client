...
template<>
result*
create_result_from_collection_mgmt_response<
                                               ...
                                               std::shared_ptr<std::promise<PyObject*>> barrier)
{
  ...
  if (resp.ctx.ec.value()) {
    pyObj_exc = build_exception_from_context(
      resp.ctx, __FILE__, __LINE__, "Error doing collection mgmt operation.", "CollectionMgmt");
...
PyObject*
handle_collection_mgmt_op(connection* conn,
                          struct collection_mgmt_options* options,
                          PyObject* pyObj_callback,
                          PyObject* pyObj_errback)
{
  ...
  switch (options->op_type) {
    ...
    case CollectionManagementOperations::CREATE_COLLECTION: {
      ...
      if (pyObj_max_expiry != nullptr) {
        ...
        if (PyErr_Occurred() != nullptr) {
          pycbc_set_python_exception(
            PycbcError::InvalidArgument, __FILE__, __LINE__, "Unabled to parse max_expiry.");
          Py_XDECREF(pyObj_callback);
          Py_XDECREF(pyObj_errback);
          return res;
        }
      ...
      res =
        do_collection_mgmt_op<couchbase::core::operations::management::collection_create_request>(
          *conn, req, pyObj_callback, pyObj_errback, barrier);
      break;
    }
    case CollectionManagementOperations::UPDATE_COLLECTION: {
      ...
      res =
        do_collection_mgmt_op<couchbase::core::operations::management::collection_update_request>(
          *conn, req, pyObj_callback, pyObj_errback, barrier);
      break;
    }
    ...
    default: {
      pycbc_set_python_exception(PycbcError::InvalidArgument,
                                 __FILE__,
                                 __LINE__,
                                 "Unrecognized collection mgmt operation passed in.");
...
add_collection_mgmt_ops_enum(PyObject* pyObj_module, PyObject* pyObj_enum_class)
{
  PyObject* pyObj_enum_values =
    PyUnicode_FromString(CollectionManagementOperations::ALL_OPERATIONS());
