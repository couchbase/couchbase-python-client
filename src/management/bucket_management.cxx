...
build_bucket_settings(couchbase::core::management::cluster::bucket_settings settings)
{
  ...
  if (settings.history_retention_collection_default.has_value()) {
    ...
    if (-1 == PyDict_SetItemString(
                pyObj_bucket_settings, "historyRetentionCollectionDefault", pyObj_tmp)) {
      Py_DECREF(pyObj_bucket_settings);
      Py_XDECREF(pyObj_tmp);
      return nullptr;
    }
...
template<>
result*
create_result_from_bucket_mgmt_response(
  const couchbase::core::operations::management::bucket_update_response& resp)
{
...
result*
create_result_from_bucket_mgmt_response(
  const couchbase::core::operations::management::bucket_get_response& resp)
{
  PyObject* pyObj_result = create_result_obj();
  result* res = reinterpret_cast<result*>(pyObj_result);
...
result*
create_result_from_bucket_mgmt_response(
  const couchbase::core::operations::management::bucket_get_all_response& resp)
{
  PyObject* pyObj_result = create_result_obj();
  result* res = reinterpret_cast<result*>(pyObj_result);
...
result*
create_result_from_bucket_mgmt_response(
  const couchbase::core::operations::management::bucket_describe_response& resp)
{
  PyObject* result_obj = create_result_obj();
  result* res = reinterpret_cast<result*>(result_obj);
                                           ...
                                           std::shared_ptr<std::promise<PyObject*>> barrier)
{
  ...
  if (set_exception) {
    pyObj_exc = pycbc_build_exception(
      PycbcError::UnableToBuildResult, __FILE__, __LINE__, "Bucket mgmt operation error.");
    if (pyObj_errback == nullptr) {
      barrier->set_value(pyObj_exc);
    } else {
      pyObj_func = pyObj_errback;
...
get_bucket_settings(PyObject* settings)
{
  ...
  if (pyObj_name == nullptr) {
    pycbc_set_python_exception(PycbcError::InvalidArgument,
                               __FILE__,
                               __LINE__,
                               "Expected bucket settings name to be provided.");
  ...
  if (pyObj_compression_mode) {
    ...
    if (comp_mode.compare("off") == 0) {
      ...
      bucket_settings.compression_mode =
        couchbase::core::management::cluster::bucket_compression::passive;
    }
  }
  ...
  PyObject* pyObj_history_retention_collection_default =
    PyDict_GetItemString(settings, "historyRetentionCollectionDefault");
  ...
  if (pyObj_history_retention_bytes != nullptr) {
    bucket_settings.history_retention_bytes =
      static_cast<uint32_t>(PyLong_AsUnsignedLong(pyObj_history_retention_bytes));
  }

  PyObject* pyObj_history_retention_duration =
    PyDict_GetItemString(settings, "historyRetentionDuration");
...
get_bucket_mgmt_with_bucket_settings_req(PyObject* op_args)
{
  ...
  if (pyObj_bucket_settings == nullptr) {
    pycbc_set_python_exception(
      PycbcError::InvalidArgument, __FILE__, __LINE__, "Expected bucket settings to be provided.");
...
get_bucket_mgmt_with_bucket_name_req(PyObject* op_args)
{
  ...
  if (pyObj_bucket_name == nullptr) {
    pycbc_set_python_exception(
      PycbcError::InvalidArgument, __FILE__, __LINE__, "Expected bucket_name to be provided.");
...
PyObject*
handle_bucket_mgmt_op(connection* conn,
                      struct bucket_mgmt_options* options,
                      PyObject* pyObj_callback,
                      PyObject* pyObj_errback)
{
    ...
    switch (options->op_type) {
      case BucketManagementOperations::CREATE_BUCKET: {
        auto req = get_bucket_mgmt_with_bucket_settings_req<
          couchbase::core::operations::management::bucket_create_request>(options->op_args);
      ...
      case BucketManagementOperations::UPDATE_BUCKET: {
        auto req = get_bucket_mgmt_with_bucket_settings_req<
          couchbase::core::operations::management::bucket_update_request>(options->op_args);
        req.timeout = options->timeout_ms;
      ...
      case BucketManagementOperations::DROP_BUCKET: {
        auto req = get_bucket_mgmt_with_bucket_name_req<
          couchbase::core::operations::management::bucket_drop_request>(options->op_args);
        req.timeout = options->timeout_ms;
      ...
      case BucketManagementOperations::GET_BUCKET: {
        auto req = get_bucket_mgmt_with_bucket_name_req<
          couchbase::core::operations::management::bucket_get_request>(options->op_args);
        req.timeout = options->timeout_ms;
      ...
      case BucketManagementOperations::FLUSH_BUCKET: {
        auto req = get_bucket_mgmt_with_bucket_name_req<
          couchbase::core::operations::management::bucket_flush_request>(options->op_args);
        req.timeout = options->timeout_ms;
      ...
      case BucketManagementOperations::BUCKET_DESCRIBE: {
        auto req = get_bucket_mgmt_with_bucket_name_req<
          couchbase::core::operations::management::bucket_describe_request>(options->op_args);
        req.timeout = options->timeout_ms;
      ...
      default: {
        pycbc_set_python_exception(PycbcError::InvalidArgument,
                                   __FILE__,
                                   __LINE__,
                                   "Unrecognized bucket mgmt operation passed in.");
