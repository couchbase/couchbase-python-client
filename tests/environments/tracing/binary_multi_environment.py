...
class BinaryMultiTracingEnvironment(BaseTracingEnvironment):
    """Environment for multi binary operation tracing tests.

    This environment is used for testing multi-document binary operations like:
    - append_multi, prepend_multi

    Documents: Loads 30 bytes documents + 30 counter documents (60 total)
    Note: Multi-ops consume 3 docs per test, so we need more documents
    """
