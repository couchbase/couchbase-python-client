...
class AsyncManagementTracingEnvironment(AsyncBaseTracingEnvironment):
    """Async management tracing environment for testing management API observability."""

    COLLECITON_MGMT_TEST_BUCKET = 'test-bucket'

    async def disable_tracing_bucket_mgmt(self) -> None:
    ...
    async def disable_tracing_collection_mgmt(self) -> None:
    ...
    async def disable_tracing_query_index_mgmt(self) -> None:
    ...
    async def enable_tracing_bucket_mgmt(self) -> None:
    ...
    async def enable_tracing_collection_mgmt(self) -> None:
    ...
    async def enable_tracing_query_index_mgmt(self) -> None:
