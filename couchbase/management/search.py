...
from couchbase.management.logic.wrappers import SearchIndexMgmtWrapper
...
class SearchIndexManager(SearchIndexManagerLogic):
    ...
    @SearchIndexMgmtWrapper.block(None, SearchIndexManagerLogic._ERROR_MAPPING)
    ...
    @SearchIndexMgmtWrapper.block(SearchIndex, SearchIndexManagerLogic._ERROR_MAPPING)
    def get_index(self,
                  index_name,  # type: str
    ...
    @SearchIndexMgmtWrapper.block(int, SearchIndexManagerLogic._ERROR_MAPPING)
    ...
    @SearchIndexMgmtWrapper.block(dict, SearchIndexManagerLogic._ERROR_MAPPING)
