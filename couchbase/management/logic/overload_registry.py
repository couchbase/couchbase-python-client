...
class OverloadedMethod:
    ...
    def __init__(self,
        ...
        self._sig_map: Dict[Signature, MethodSignature] = {}
        self._default_fn: Callable[..., Any] = None
    ...
    def register(self,
        ...
        self._sig_map[sig] = MethodSignature(fn, get_type_hints(fn))
        if is_default is True:
            self.register_default(fn)
        self._add_overload_types(overload_types)

    def register_default(self, fn: Callable[..., Any]) -> None:
        ...
        for sig, meth_sig in self._sig_map.items():
            ...
            try:
                ...
                if self._validate_params(params, bound_args, meth_sig.type_hints):
                    ...
                    return meth_sig.fn(*args, **kwargs)
...
class OverloadRegistry(dict):
    ...
    def add_overload(self,
                     ...
                     is_default: Optional[bool] = False,
                     overload_types: Optional[List[str]] = None) -> None:
        meth: OverloadedMethod = self.get(fn.__qualname__)
        meth.register(fn, is_default=is_default, overload_types=overload_types)

    def __getitem__(self, key: str) -> OverloadedMethod:
        return super().__getitem__(key)

    def __setitem__(self, key: str, item: OverloadedMethod) -> None:
