...
# Content-Hash: cda785d9e3fda57b1ccf70fb5a2e4d81
# ====================================================================================================
    # ==========================================================================================
    # Key-Value Operations
    # ==========================================================================================

    def pycbc_append(self, **kwargs: Unpack[CppTypes.CppAppendRequest]) -> pycbc_result[CppTypes.CppAppendResponse]:
        ...

    def pycbc_append_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppAppendWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppAppendResponse]:
        ...

    def pycbc_decrement(self, **kwargs: Unpack[CppTypes.CppDecrementRequest]) -> pycbc_result[CppTypes.CppDecrementResponse]:
        ...

    def pycbc_decrement_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppDecrementWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppDecrementResponse]:
        ...

    def pycbc_exists(self, **kwargs: Unpack[CppTypes.CppExistsRequest]) -> pycbc_result[CppTypes.CppExistsResponse]:
        ...

    def pycbc_get(self, **kwargs: Unpack[CppTypes.CppGetRequest]) -> pycbc_result[CppTypes.CppGetResponse]:
        ...

    def pycbc_get_all_replicas(self, **kwargs: Unpack[CppTypes.CppGetAllReplicasRequest]) -> pycbc_streamed_result[Any]:
        ...

    def pycbc_get_and_lock(self, **kwargs: Unpack[CppTypes.CppGetAndLockRequest]) -> pycbc_result[CppTypes.CppGetAndLockResponse]:
        ...

    def pycbc_get_and_touch(self, **kwargs: Unpack[CppTypes.CppGetAndTouchRequest]) -> pycbc_result[CppTypes.CppGetAndTouchResponse]:
        ...

    def pycbc_get_any_replica(self, **kwargs: Unpack[CppTypes.CppGetAnyReplicaRequest]) -> pycbc_result[CppTypes.CppGetAnyReplicaResponse]:
        ...

    def pycbc_get_projected(self, **kwargs: Unpack[CppTypes.CppGetProjectedRequest]) -> pycbc_result[CppTypes.CppGetProjectedResponse]:
        ...

    def pycbc_increment(self, **kwargs: Unpack[CppTypes.CppIncrementRequest]) -> pycbc_result[CppTypes.CppIncrementResponse]:
        ...

    def pycbc_increment_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppIncrementWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppIncrementResponse]:
        ...

    def pycbc_insert(self, **kwargs: Unpack[CppTypes.CppInsertRequest]) -> pycbc_result[CppTypes.CppInsertResponse]:
        ...

    def pycbc_insert_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppInsertWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppInsertResponse]:
        ...

    def pycbc_lookup_in(self, **kwargs: Unpack[CppTypes.CppLookupInRequest]) -> pycbc_result[CppTypes.CppLookupInResponse]:
        ...

    def pycbc_lookup_in_all_replicas(self, **kwargs: Unpack[CppTypes.CppLookupInAllReplicasRequest]) -> pycbc_streamed_result[Any]:
        ...

    def pycbc_lookup_in_any_replica(self, **kwargs: Unpack[CppTypes.CppLookupInAnyReplicaRequest]) -> pycbc_result[CppTypes.CppLookupInAnyReplicaResponse]:
        ...

    def pycbc_mutate_in(self, **kwargs: Unpack[CppTypes.CppMutateInRequest]) -> pycbc_result[CppTypes.CppMutateInResponse]:
        ...

    def pycbc_mutate_in_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppMutateInWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppMutateInResponse]:
        ...

    def pycbc_prepend(self, **kwargs: Unpack[CppTypes.CppPrependRequest]) -> pycbc_result[CppTypes.CppPrependResponse]:
        ...

    def pycbc_prepend_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppPrependWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppPrependResponse]:
        ...

    def pycbc_remove(self, **kwargs: Unpack[CppTypes.CppRemoveRequest]) -> pycbc_result[CppTypes.CppRemoveResponse]:
        ...

    def pycbc_remove_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppRemoveWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppRemoveResponse]:
        ...

    def pycbc_replace(self, **kwargs: Unpack[CppTypes.CppReplaceRequest]) -> pycbc_result[CppTypes.CppReplaceResponse]:
        ...

    def pycbc_replace_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppReplaceWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppReplaceResponse]:
        ...

    def pycbc_touch(self, **kwargs: Unpack[CppTypes.CppTouchRequest]) -> pycbc_result[CppTypes.CppTouchResponse]:
        ...

    def pycbc_unlock(self, **kwargs: Unpack[CppTypes.CppUnlockRequest]) -> pycbc_result[CppTypes.CppUnlockResponse]:
        ...

    def pycbc_upsert(self, **kwargs: Unpack[CppTypes.CppUpsertRequest]) -> pycbc_result[CppTypes.CppUpsertResponse]:
        ...

    def pycbc_upsert_with_legacy_durability(self, **kwargs: Unpack[CppTypes.CppUpsertWithLegacyDurabilityRequest]) -> pycbc_result[CppTypes.CppUpsertResponse]:
        ...
    ...
    def pycbc_append_multi(self, **kwargs: Unpack[CppTypes.CppAppendMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppAppendResponse]]:
        ...

    def pycbc_append_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppAppendWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppAppendResponse]]:
        ...

    def pycbc_decrement_multi(self, **kwargs: Unpack[CppTypes.CppDecrementMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppDecrementResponse]]:
        ...

    def pycbc_decrement_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppDecrementWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppDecrementResponse]]:
        ...

    def pycbc_exists_multi(self, **kwargs: Unpack[CppTypes.CppExistsMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppExistsResponse]]:
        ...

    def pycbc_get_multi(self, **kwargs: Unpack[CppTypes.CppGetMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppGetResponse]]:
        ...

    def pycbc_get_all_replicas_multi(self, **kwargs: Unpack[CppTypes.CppGetAllReplicasMultiRequest]) -> pycbc_result[Dict[str, pycbc_streamed_result[Any]]]:
        ...

    def pycbc_get_and_lock_multi(self, **kwargs: Unpack[CppTypes.CppGetAndLockMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppGetAndLockResponse]]:
        ...

    def pycbc_get_and_touch_multi(self, **kwargs: Unpack[CppTypes.CppGetAndTouchMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppGetAndTouchResponse]]:
        ...

    def pycbc_get_any_replica_multi(self, **kwargs: Unpack[CppTypes.CppGetAnyReplicaMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppGetAnyReplicaResponse]]:
        ...

    def pycbc_increment_multi(self, **kwargs: Unpack[CppTypes.CppIncrementMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppIncrementResponse]]:
        ...

    def pycbc_increment_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppIncrementWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppIncrementResponse]]:
        ...

    def pycbc_insert_multi(self, **kwargs: Unpack[CppTypes.CppInsertMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppInsertResponse]]:
        ...

    def pycbc_insert_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppInsertWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppInsertResponse]]:
        ...

    def pycbc_prepend_multi(self, **kwargs: Unpack[CppTypes.CppPrependMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppPrependResponse]]:
        ...

    def pycbc_prepend_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppPrependWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppPrependResponse]]:
        ...

    def pycbc_remove_multi(self, **kwargs: Unpack[CppTypes.CppRemoveMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppRemoveResponse]]:
        ...

    def pycbc_remove_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppRemoveWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppRemoveResponse]]:
        ...

    def pycbc_replace_multi(self, **kwargs: Unpack[CppTypes.CppReplaceMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppReplaceResponse]]:
        ...

    def pycbc_replace_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppReplaceWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppReplaceResponse]]:
        ...

    def pycbc_touch_multi(self, **kwargs: Unpack[CppTypes.CppTouchMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppTouchResponse]]:
        ...

    def pycbc_unlock_multi(self, **kwargs: Unpack[CppTypes.CppUnlockMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppUnlockResponse]]:
        ...

    def pycbc_upsert_multi(self, **kwargs: Unpack[CppTypes.CppUpsertMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppUpsertResponse]]:
        ...

    def pycbc_upsert_with_legacy_durability_multi(self, **kwargs: Unpack[CppTypes.CppUpsertWithLegacyDurabilityMultiRequest]) -> pycbc_result[Dict[str, CppTypes.CppUpsertResponse]]:
        ...
