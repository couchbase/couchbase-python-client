...
class CollectionManagerTestCase(CollectionTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.try_n_times(10, 1, self.bm.create_bucket, CreateBucketSettings(
    ...
    def testCreateCollectionMaxTTL(self):
        ...
        coll = self.try_n_times(
            10,
            1,
            self.other_bucket.collection,
            'other-collection')
