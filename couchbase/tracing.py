...
class CouchbaseSpan(ABC):
    ...
    def set_attribute(self,
        ...
        # type: (...) -> None
        """
        This method will need to be implemented in derived classes.  Given a key, and a value, use the underlying `self._span`
        to set an attribute on the span.
    ...
    def finish(self):
        # type: (...) -> None
        """
         This method will need to be implemented in derived classes.  Using `self._span`, the intent is to finish the span.
         """
        pass
...
class CouchbaseTracer(ABC):
    ...
    def start_span(self,
                   name,    # type: str
                   parent   # type: CouchbaseSpan
                   ):
        # type: (...) -> CouchbaseOtelSpan
        """
        This method must be implemented in derived classes.  The intent is to use the underlying `self._tracer` to actually
        start a span, and return it wrapped in a :class:`CouchbaseSpan`.  See :class:`CouchbaseOtelTracer` for and example.

        :param: str name: Name of the span.
        :param CouchbaseSpan parent: Parent span, if any.  Will be None when this is to be a top-level span.
        :return: A new CouchbaseSpan, wrapping a span created by the wrapped tracer.
        """
        pass
