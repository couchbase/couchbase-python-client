...
class PingOptions(PingOptionsBase):
    ...
    Args:
        ...
        service_types (Union[Iterable[class:`~couchbase.diagnostics.ServiceType`], Iterable[str]]): The
            services which should be pinged.  Either every element is a
            :class:`~couchbase.diagnostics.ServiceType` or every element is its ``.value`` string;
            the two forms are equivalent and are not intended to be mixed within one iterable.
    """
...
class MutateInOptions(MutateInOptionsBase):
    ...
    Args:
        ...
        timeout (timedelta, optional): The timeout for this operation. Defaults to global
            subdocument operation timeout.
        expiry (timedelta, optional): Specifies the expiry time for this document. Cannot be
            combined with preserve_expiry.
        durability (:class:`~couchbase.durability.DurabilityType`, optional): Specifies the level of durability
            for this operation.
        preserve_expiry (bool, optional): Specifies that any existing expiry on the document should be preserved.
...
class ViewOptions(ViewOptionsBase):
    ...
    Args:
        ...
        keys (Sequence[JSONType], optional): Specifies a list of keys which should be fetched from the index.
            Defaults to None.
