...
from couchbase.options import (ClusterOptions,
                               ...
                               DecrementMultiOptions, IncrementOptions,
                               SignedInt64)
from couchbase.result import CounterResult, MutationResult, MultiMutationResult, MultiCounterResult
...
class BinaryCollectionMultiTests:
    ...
    def test_counter_multi_increment_non_default_per_key(self, cb_env, counter_keys):
        key1 = counter_keys[0]
        opts = IncrementMultiOptions(initial=SignedInt64(3), per_key_options={key1:IncrementOptions(initial=SignedInt64(100))})
    ...
    def test_counter_multi_decrement_non_default_per_key(self, cb_env, counter_keys):
        key1 = counter_keys[0]
        opts = DecrementMultiOptions(initial=SignedInt64(3), per_key_options={key1:DecrementOptions(initial=SignedInt64(100))})
