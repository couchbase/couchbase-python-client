...
class QueryIndexManagementTestSuite:
    ...
    #     cb_env.qixm.create_index(cb_env.bucket.name, ixname, [], primary=True)
    #     cb_env.cluster.query(n1ql).execute()
...
class ClassicQueryIndexManagementCollectionTests(QueryIndexManagementCollectionTestSuite):
    ...
    def test_manifest_validated(self):
        ...
        compare = set(QueryIndexManagementCollectionTestSuite.TEST_MANIFEST).difference(method_list)
        return compare
...
class ClassicQueryIndexManagementTests(QueryIndexManagementTestSuite):
    ...
    def test_manifest_validated(self):
        ...
        compare = set(QueryIndexManagementTestSuite.TEST_MANIFEST).difference(method_list)
        return compare
