...
ClusterImpl.transactions was a bare check-then-set, so threads racing the
...
class TransactionsPropertyRaceTestSuite:
    ...
    def tracking_transactions_cls(self, monkeypatch):
        """A stand-in for couchbase.transactions.Transactions.
        ...
        monkeypatch.setattr('couchbase.logic.cluster_impl.Transactions', _Tracker)
        return _Tracker
