...
class DataStructuresMetricsTestsSuite:
    ...
    @pytest.mark.asyncio
    async def test_kv_ds_list(self, acb_env: AsyncMetricsEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_kv_ds_map(self, acb_env: AsyncMetricsEnvironment) -> None:
        test_key = acb_env.get_new_doc(key_only=True)
    ...
    @pytest.mark.asyncio
    async def test_kv_ds_queue(self, acb_env: AsyncMetricsEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_kv_ds_set(self, acb_env: AsyncMetricsEnvironment) -> None:
        test_key = acb_env.get_new_doc(key_only=True)
...
class ClassicDataStructuresMetricsTests(DataStructuresMetricsTestsSuite):
    ...
    async def couchbase_test_environment(self, cb_base_env, request):
        # Data structures use AsyncMetricsEnvironment (same as single KV ops)
