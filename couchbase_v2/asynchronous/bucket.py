...
class AsyncBucket(Bucket):
    ...
    :class:`~couchbase_v2.bucket.Bucket` interface. **This module is not intended to be
    ...
    implementation (see :class:`~couchbase_v2.iops.base.IOPS`). The
    ...
    * Coroutine-based asynchronous programming, that involves
    ...
    `Bucket` functions (for example, :meth:`~couchbase_v2.bucket.Bucket.get` operate:
