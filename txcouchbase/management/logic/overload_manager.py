...
from couchbase.management.logic.overload_registry import OverloadRegistry

mgmt_registry = OverloadRegistry()
...
class OverloadManager:
    ...
    def handle_overload(cls,
        ...
        def decorator(fn: Callable[..., Deferred[Any]]) -> Callable[..., Deferred[Any]]:
            ...
            @wraps(fn)
            def wrapped_fn(self, *args: Any, **kwargs: Dict[str, Any]):
